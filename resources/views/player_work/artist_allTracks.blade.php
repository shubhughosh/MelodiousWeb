        ...
        <div class="row">
            <div class="col-lg-10 mx-auto">
                <div class="card border-0 shadow-sm" style="background-color: rgba(206, 109, 109, 0.26)">
                    <div class="card-body">
                        @foreach ($artist_profile as $art)
                        <div class="row">
                            <div class="col-lg-3">
                                <img src="{{asset('artist_profile/'.$art->profile)}}" class="card-img-top">
                            </div>
                            <div class="col-lg-6 mt-1">
                                <h4>Best of {{$art->artist_name}}</h4>
                                @endforeach
                        ...
                        <table class="table table-borderless text-white mt-4">
                            ...
                            <tr style="border-bottom: 0.1rem solid rgb(228, 227, 227);margin-bottom:2px">
                                ...
                                <td>{{$alltrk->genres}}</td>
                                <td>
                                    <a href="{{ route('allTracks',['id'=>$alltrk->id,'name'=>$alltrk->name,'singer'=>$alltrk->singer]) }}" class="btn btn-danger btn-sm" style="border-radius:100px"><i class="fas fa-play"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </table>
